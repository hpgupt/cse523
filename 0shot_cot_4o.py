# -*- coding: utf-8 -*-
"""AP1-0shot-CoT-4o.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kDcqnSbodS10pKdzopSfzOvB3FxUHaQr
"""
...
df.to_csv(data_path+"output_yt_0shot-cot.csv", index=False)
...
result_df_yt1  = pd.read_csv(data_path+"output_yt_0shot-cot1.csv")
result_df_yt2  = pd.read_csv(data_path+"output_yt_0shot-cot2.csv")
result_df_yt3  = pd.read_csv(data_path+"output_yt_0shot-cot3.csv")
result_df_yt = pd.concat([result_df_yt1, result_df_yt2, result_df_yt3], ignore_index=True)
# result_df_tw  = pd.read_csv(data_path+"output_tw_0shot.csv")

result_df_yt.to_csv(data_path+"output_yt_0shot-cot.csv", index=False)
