# -*- coding: utf-8 -*-
"""AP1-0shot-no-topic.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1F-LhqaBaq-YO-Cl8XPqpxQiNzd_Q_Ebg
"""
...
df.to_csv(data_path+"output_yt_0shot-notopic.csv", index=False)
...
prompt_template_tw = ChatPromptTemplate.from_template(
    """
    There are two pieces of information provided:
    This reply tweet left by a user on another tweet: "{comment}"
    Whataboutism is the practice of deflecting criticism or avoiding an unfavorable issue by raising a different, more favorable matter, or by making a counter accusation.
...
t_df.to_csv(data_path+"output_tw_0shot-notopic.csv", index=False)
...
result_df_yt  = pd.read_csv(data_path+"output_yt_0shot-notopic.csv")
result_df_tw  = pd.read_csv(data_path+"output_tw_0shot-notopic.csv")
