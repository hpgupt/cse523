# -*- coding: utf-8 -*-
"""AP1-0shot-notopic-nodef.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1k8sz3rzAoc9GDbQR8Qe1qLO4pyVKKCW2
"""
...
llm = ChatOpenAI(model="gpt-4o", temperature=0.2, max_tokens=100)
...
prompt_template = ChatPromptTemplate.from_template(
    ...
    This comment left by a user on a youtube video: "{comment}"
...
df.to_csv(data_path+"output_yt_0shot_notopic_nodef.csv", index=False)
...
prompt_template_tw = ChatPromptTemplate.from_template(
    ...
    Identify whether the above reply tweet exhibits whataboutism. Respond with only one of the two options: "whataboutism" or "not whataboutism".
    """
)
...
t_df.to_csv(data_path+"output_tw_0shot-notopic-nodef.csv", index=False)
...
result_df_yt  = pd.read_csv(data_path+"output_yt_0shot_notopic_nodef.csv")
result_df_tw  = pd.read_csv(data_path+"output_tw_0shot-notopic-nodef.csv")
